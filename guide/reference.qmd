...
| `--pap` | Strategist (PAP mode) | Pre-analysis plan in AEA/OSF/EGAP format *(experimental/RCT only)* |
...
**Saves to:** `scripts/`, `Paper/tables/`, `Paper/figures/`, `Output/cross_language_comparison.md`
